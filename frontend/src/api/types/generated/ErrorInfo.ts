...
export type ErrorInfo =
  ...
  | { kind: 'fields_required'; fields: Array<Field> }
  | { kind: 'invalid_value'; field: Field; reason: Reason }
  | { kind: 'mutually_exclusive'; options: Array<string> }
  ...
  | { kind: 'unsupported_content_url'; url: string }
  | {
      kind: 'content_kind_mismatch';
      title: string;
      actual: ContentKind;
  ...
  | { kind: 'incompatible_version'; got: number; want: number }
  | { kind: 'io'; operation: IoOp; detail: string }
