...
> takes.
>
> **Content.** Mods, plugins, resourcepacks, shaders and datapacks from
> Modrinth, a page URL or a local file, with dependencies resolved. Whole
> modpacks install into a new or existing entry, their mods joining the pool as
> ordinary updatable content. An instance's pool can be sliced into named
> content profiles, and reusable global profiles apply project references across
> instances.
>
