...
namespace desktop::common {
    ...
    namespace {
        ...
        std::string MimeFor(const std::string &path) {
            ...
            if (mime.empty()) mime = (ext == "js" || ext == "mjs") ? "text/javascript" : "application/octet-stream";
            return mime;
        }
        ...
        public:
            CefRefPtr<CefResourceHandler> Create(CefRefPtr<CefBrowser>, CefRefPtr<CefFrame>, const CefString &,
                ...
                auto stream = CefStreamReader::CreateForData(const_cast<char *>(f.begin()), f.size());
    ...
    void RegisterCustomSchemes(CefRawPtr<CefSchemeRegistrar> registrar) {
        registrar->AddCustomScheme(APP_SCHEME, CEF_SCHEME_OPTION_STANDARD | CEF_SCHEME_OPTION_SECURE |
